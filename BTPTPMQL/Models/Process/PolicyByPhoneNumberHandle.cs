...
public class PolicyByPhoneNumberHanle : AuthorizationHandler<PolicyByPhoneNumberRequirement>
{
    private readonly IServiceProvider _serviceProvider;
    public PolicyByPhoneNumberHanle(IServiceProvider serviceProvider)
    {
